...
import com.senac.erick.service.JwtTokenService;
import com.senac.erick.service.UserDetailsImpl;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (checkIfEndpointIsNotPublic(request)) {
            ...
            if (token != null) {
                ...
                Integer id = Integer.parseInt(subject);// Obtém o assunto (neste caso, o nome de usuário) do token
                Funcionario funcionario = funcionarioRepository.funcionarioPorId(id); // Busca o usuário pelo email (que é o assunto do token)
                UserDetailsImpl userDetails = new UserDetailsImpl(funcionario); // Cria um UserDetails com o usuário encontrado
